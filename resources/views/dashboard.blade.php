<x-layouts.app>
    <div>
        <flux:sidebar class="bg-cedea-dark" stashable>
            ...
            <flux:navlist variant="outline">
                <flux:navlist.group class="grid" :heading="__('Platform')">
                    ...
                    <flux:navlist.item icon="home" :href="route('dashboard')" :current="false" wire:navigate>
                        {{ __('Dashboard') }}
                    </flux:navlist.item>
            ...
            <flux:navlist variant="outline">
                <flux:navlist.item class="!text-white" icon="folder-git-2"
                    href="https://github.com/laravel/livewire-starter-kit" target="_blank">
                    {{ __('Repository') }}
                </flux:navlist.item>

                <flux:navlist.item class="!text-white" icon="book-open-text"
            ...
            <flux:dropdown class="hidden lg:block" position="bottom" align="start">
                <flux:profile data-test="sidebar-menu-button" :name="auth()->user()->name"
