<div @class([
    'terms-list list bg-white',
    'clamp-[p,8,14] clamp-[pb,4,8] rounded-3xl md:rounded-[3rem] flex flex-col gap-8' =>
        $register ?? false,
])>
    ...
    @if ($register ?? false)
        <div class="flex items-center justify-center">
            <flux:button class="px-8! w-fit" variant="primary" wire:click='acceptTerms'>
