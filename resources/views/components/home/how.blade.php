<div class="clamp-[my,8,16] flex w-full flex-col gap-y-3 max-lg:order-1">
    <div
        class="rounded-4xl clamp-[px,4,8] clamp-[py,4,12] clamp-[pt,12,24] relative grid items-center justify-center gap-x-12 gap-y-12 bg-white drop-shadow-2xl md:grid-cols-3 lg:grid-rows-[1fr_auto]">
