    ...
    @if ($is_campaign_end)
        <div class="order-1 flex flex-col gap-4 text-white">
            <div @class([
                ...
                <div @class([
                    'text-cedea-red font-montserrat text-lg font-bold md:w-2/3 md:text-xl',
                ])>
                    <p>Batas waktu upload sudah lewat</p>
                    <p>Pemenang akan diumumkan dan diundi setelah pengundian</p>
                </div>
            </div>
        @else
            <div class="order-1 flex flex-col gap-4 text-white">
