...
<body
    ...
    <table border="0" align="center" cellpadding="0" cellspacing="0" width="100%"
        ...
        <tr><!-- Outer Table -->
            <td data-composer align="center" bgcolor="#f0f0f0">

                <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%"
                    style="width:100%;max-width:100%;">
                    <!-- lotus-header-18-->
                    <tr>
                        <td class="container-padding" align="center" bgcolor="#343e9e">
                                        ...
                                        <table border="0" align="center" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr>
                                                <td class="container-padding" align="center">
                                                    ...
                                                    <!-- gap -->
                                                    <table class="row" border="0" align="right" cellpadding="0"
                                                    ...
                                                    <!-- column -->
                                                    <table class="row" border="0" align="right" cellpadding="0"
                                                        cellspacing="0" role="presentation" width="280"
                                ...
                                <tr>
                                    <td class="center-text" align="center">
                                        <img style="width:190px;border:0px;display: inline!important;"
                                            src="{{ asset('assets/img/emails/Email-18_Intro.png') }}" width="190"
                                            border="0" alt="intro">
                                    </td>
                                </tr>
                                <tr>
                ...
                <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation"
                    ...
                    <!-- lotus-content-18 -->
                    <tr>
                        <td class="container-padding" align="center" bgcolor="#FFFFFF">
                                ...
                                <tr>
                                    <td align="center" bgcolor="#f4f5fa">
                                        ...
                                        <table class="row" border="0" align="center" cellpadding="0"
                                            cellspacing="0" role="presentation" width="480"
                                            ...
                                            <tr>
                                                <td align="center">
                                                    ...
                                                    <!-- Column -->
                                                    <table class="row" border="0" align="left"
                                ...
                                <tr>
                                    <td align="center">
                                        ...
                                        <table class="row" border="0" cellspacing="0" cellpadding="0"
                                            role="presentation" align="center" width="480"
                                            style="width:480px;max-width:480px;">
                                            <tr>
                                                <td class="center-text" align="center"
                                                    ...
                                                    <div>
                                                        ({{ __('If you have any questions or feedback, just') }} <a
                                                            href="mailto:{{ config('pleb.mail.info_email') }}"
                                                            style="color:#ed6e7a;text-decoration: underline;">{{ __('reply to this email') }}</a>)
                                                    </div>
                ...
                <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation"
                    ...
                    <!-- lotus-footer-18 -->
                    <tr>
                        <td class="container-padding" align="center" bgcolor="#f0f0f0">
