...
return [
    'title' => 'Experience the Delicacy of <span class="~text-2xl/6xl"><span class="font-cedea">CEDEA</span> Seafood</span> from <span class="~text-2xl/6xl">Home!</span>',
    'cta' => 'Order <span class="font-cedea">CEDEA</span> Seafood Now!',
    'heading' => 'Enjoy the Taste of the Sea Right from Home with <span class="font-cedea">CEDEA</span> Seafood!',
